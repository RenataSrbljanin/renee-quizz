...
/*
 @author RenataS created 04.05.2018.
*/
public class QuestionArrayAccess implements QuestionAccessible {
	...
	// Force conversion from long to int intentionally
	...
	// Convert var args into a List

	List<Long> ids = Arrays.stream(id)
				.boxed()
				.collect(Collectors.toList());
	// Filters the question list to contains only questions with the given
	// ids
	...
	questionList.add((new QuestionBuilder())
		.id(0).question("How many feet are in a mile?")
		.answerA("5260")
		.answerB("5270")
		.answerC("5280")
		.answerD("5290")
	...
	questionList.add((new QuestionBuilder())
		...
		.build());
	questionList.add((new QuestionBuilder())
		.id(6).question("What is the largest animal currently on Earth?")
		.answerA("Elephant")
		.answerB("Polar Bear")
		.answerC("Blue Whale")
